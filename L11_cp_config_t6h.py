    ...
    if build_side == "QTMC" or build_side == "QMF":
        ...
        for i in range(len(ip)):
            ...
            if ret == 0:
                ...
                return tmp
        # Eirc C in QCI lab mac == null cant send ip into log
...
#            : Step 4. If step1 failed, remove <CP_SN>_update_flag and remove do_record_cp_golden_image_version file.
#            : Step 5. If step2 failed, remove do_record_cp_golden_image_version file.
# Inputs	 : sn_info_list: SN list information
# Outputs	 : 0: PASS
#			 : 1: FAIL
# Notice	 :
...
def create_auto_reconfig_file(sn_info_list):
    ...
    while get_ReconServ_md5 != expected_ReconServ_md5:
        ...
        if ret != 0:
            ...
            if res != "":
                for line in res.splitlines():
                    # Eric C 2024 12 23 Fix the issue where incorrect value assignment might cause the loop to fail to exit properly.
